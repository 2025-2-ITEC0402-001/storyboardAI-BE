...
public class AIImageController implements AIImageApi {
    ...
    @Override
    @RequireAuth
    public ResponseEntity<ImageGenerationTaskResponse> generateImage(String prompt, Integer height, Integer width,
                                                                     Double guidanceScale, Integer numInferenceSteps,
                                                                     Integer seed,
    ...
    @Override
    @RequireAuth
    public ResponseEntity<ImageGenerationTaskResponse> reviseImage(MultipartFile image, String revisedPrompt,
                                                                   Double strength, Double guidanceScale,
                                                                   Integer numInferenceSteps, Integer seed,
                                                                   @Parameter(hidden = true) @Login AuthUser authUser) {

        ReviseImageRequest request = new ReviseImageRequest(
                image, revisedPrompt, strength, guidanceScale, numInferenceSteps, seed
        );
